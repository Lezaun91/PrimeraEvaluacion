...
public class Ejercicio13 {
    public static void main(String[] args) {
        ...
        int billetes500 = euros/500;// en el resto queda los demás
        ...
        System.out.println(euros + "euros " + billetes500 + "billetes de 500 " + billetes200 + "billetes de 200 " + billetes100 + "billetes de 100" + billetes50 + " billetes de 50" + billetes20 + " billetes de 20 " + billetes10 + "billetes de 10" + billetes5 + " billetes de 5 "+  monedas2 + " monedas de 2 euros " + monedas1 + " monedas de 1 euros");
